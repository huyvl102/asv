                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn" id="budget-summary-tab" data-toggle="tab"
                           href="#budget-summary-tab-pane" role="tab"
                           aria-controls="budget-summary-tab-pane">Budget Summary</a>
                    </li>
                        ...
                        <div class="widget-group row no-gutters">
                            ...
                            <div class="col-12 col-sm-6 col-xl-3 p-3">
                                ...
                                <div class="widget widget1 card">
                                    ...
                                    <div
                                        class="widget-footer p-4 bg-light row no-gutters align-items-center">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/james.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/katherine.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/andrew.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/jane.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/alice.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/vincent.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/joyce.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/danielle.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/carl.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/profile.jpg') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="avatar"
                                                         src="{{ asset('assets/images/avatars/garry.jpg') }}">
...
@endsection
@section('script')
    <script type="text/javascript" src="{{ asset('assets/js/apps/dashboard/project.js') }}"></script>
@endsection
